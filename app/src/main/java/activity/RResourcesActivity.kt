...
import kotlinx.android.synthetic.main.aeresource.*

class RResourcesActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.aeresource)
        ...
        buttonnext.setOnClickListener{
            startActivity(Intent(this@RResourcesActivity, SetReminderActivity::class.java))
            finish()
        }
