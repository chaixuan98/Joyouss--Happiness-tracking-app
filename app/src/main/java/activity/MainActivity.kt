...
//screen showing activity evoked from home menu
...
class MainActivity : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //to determine whether the activity is launched before
        ...
        if(sharedIdValue.equals(0)){
            initAct() //initialise activity if first time launch
        ...
        next.setOnClickListener{
            startActivity(Intent(this@MainActivity,RateActivity::class.java))
            finish()
        }
    }

    //bind activities cards and view holder into recyclerview
